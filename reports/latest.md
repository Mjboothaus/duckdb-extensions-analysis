...
|---|---|---|
| [mssql](https://duckdb.org/community_extensions/extensions/mssql.html) | [mssql-extension](https://github.com/hugr-lab/mssql-extension) | today (2026-08-24 08:09:03 UTC) |
...
| 19 | [parquet](https://duckdb.org/docs/current/data/parquet/overview) | [duckdb/duckdb](https://github.com/duckdb/duckdb/tree/main/extension/parquet) | 🟢 Ongoing | today (2026-08-23 22:36:02 UTC) | N/A (part of core DuckDB repo) | C++ | Core DuckDB extension: parquet |
...
| 90 | [duckpgq](https://duckdb.org/community_extensions/extensions/duckpgq.html) | [duckpgq-extension](https://github.com/cwida/duckpgq-extension) | ❓ Unknown | 1 - 🔥 Very Active | 6 days ago (2026-08-17 15:28:10 UTC) | 482 | C++ | DuckDB extension that adds support for SQL/PGQ and graph algorithms |
...
| 141 | [hnsw_acorn](https://duckdb.org/community_extensions/extensions/hnsw_acorn.html) | [duckdb-hnsw-acorn](https://github.com/cigrainger/duckdb-hnsw-acorn) | ❓ Unknown | 4 - 🟠 Stale | 149 days ago (2026-03-28 07:49:47 UTC) | 65 | C++ | ACORN-1 pre-filtered HNSW search for DuckDB |
...
| 159 | [jsono](https://duckdb.org/community_extensions/extensions/jsono.html) | [duckdb-jsono](https://github.com/Flamefork/duckdb-jsono) | 🟢 Ongoing | 1 - 🔥 Very Active | 2 days ago (2026-08-22 07:35:03 UTC) | 0 | C++ | A DuckDB extension for analytics-optimized JSON storage and querying |
...
| 173 | [lttb](https://duckdb.org/community_extensions/extensions/lttb.html) | [duckdb-lttb](https://github.com/reformovo/duckdb-lttb) | ❓ Unknown | 3 - 🟡 Stable | 54 days ago (2026-07-01 07:47:53 UTC) | 2 | C++ | A simple lttb algorithm extension for DuckDB |
...
| 176 | [magic](https://duckdb.org/community_extensions/extensions/magic.html) | [duckdb-magic](https://github.com/carlopi/duckdb-magic) | ❓ Unknown | 3 - 🟡 Stable | 63 days ago (2026-06-22 07:17:42 UTC) | 8 | C++ | Auto-detect file types via `libmagic` (`file` utility) |
...
| 187 | [mooncake](https://duckdb.org/community_extensions/extensions/mooncake.html) | [duckdb_mooncake](https://github.com/Mooncake-Labs/duckdb_mooncake) | ❓ Unknown | 4 - 🟠 Stale | 302 days ago (2025-10-26 07:13:05 UTC) | 10 | C++ | Read Iceberg tables written by moonlink in real time |
...
| 191 | [mssql](https://duckdb.org/community_extensions/extensions/mssql.html) | [mssql-extension](https://github.com/hugr-lab/mssql-extension) | 🟢 Ongoing | 1 - 🔥 Very Active | today (2026-08-24 08:09:03 UTC) | 126 | C++ | DuckDB extension for Microsoft SQL Server (TDS + TLS), with catalog integrati... |
...
| 195 | [netquack](https://duckdb.org/community_extensions/extensions/netquack.html) | [duckdb-netquack](https://github.com/hatamiarash7/duckdb-netquack) | ❓ Unknown | 2 - ✅ Active | 30 days ago (2026-07-25 07:00:30 UTC) | 42 | C++ | DuckDB extension for parsing, extracting, and analyzing domains, URIs, and pa... |
