...
**Note:** For releases prior to v0.5.0, please refer to the [official DuckDB documentation](https://duckdb.org/docs/archive/0.9.2/installation/index) for historical version information.
