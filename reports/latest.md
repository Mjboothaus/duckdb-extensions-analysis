...
Generated on: **2025-09-19 23:24:15 UTC**
...
|-----------|-------------------|--------|--------------|
| **[autocomplete](https://duckdb.org/docs/stable/core_extensions/autocomplete.html)** | Stable | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[avro](https://duckdb.org/docs/stable/core_extensions/avro.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[aws](https://duckdb.org/docs/stable/core_extensions/aws.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[azure](https://duckdb.org/docs/stable/core_extensions/azure.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[delta](https://duckdb.org/docs/stable/core_extensions/delta.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[ducklake](https://duckdb.org/docs/stable/core_extensions/ducklake.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[encodings](https://duckdb.org/docs/stable/core_extensions/encodings.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[excel](https://duckdb.org/docs/stable/core_extensions/excel.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[fts](https://duckdb.org/docs/stable/core_extensions/full_text_search.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[httpfs](https://duckdb.org/docs/stable/core_extensions/httpfs/overview.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[iceberg](https://duckdb.org/docs/stable/core_extensions/iceberg/overview.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[icu](https://duckdb.org/docs/stable/core_extensions/icu.html)** | Stable | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[inet](https://duckdb.org/docs/stable/core_extensions/inet.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[jemalloc](https://duckdb.org/docs/stable/core_extensions/jemalloc.html)** | Stable | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **json** | Stable | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[mysql](https://duckdb.org/docs/stable/core_extensions/mysql.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **parquet** | Stable | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[postgres](https://duckdb.org/docs/stable/core_extensions/postgres.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[spatial](https://duckdb.org/docs/stable/core_extensions/spatial/overview.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[sqlite](https://duckdb.org/docs/stable/core_extensions/sqlite.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[tpcds](https://duckdb.org/docs/stable/core_extensions/tpcds.html)** | Stable | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[tpch](https://duckdb.org/docs/stable/core_extensions/tpch.html)** | Stable | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[ui](https://duckdb.org/docs/stable/core_extensions/ui.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
| **[vss](https://duckdb.org/docs/stable/core_extensions/vss.html)** | GitHub | ✅ Ongoing | 3 days ago (in v1.4.0) |
...
|-----------|------------|--------|-----------|-------|----------|-------------|
| **chaos** | [taniabogatsch/duckdb-chaos](https://github.com/taniabogatsch/duckdb-chaos) | ✅ Ongoing | 0 days ago | 0 | C++ | DuckDB extension: chaos by taniabogatsch |
| **cwiqduck** | [cwiq-os/cwiqduck](https://github.com/cwiq-os/cwiqduck) | ✅ Ongoing | 0 days ago | 1 | C++ | DuckDB extensions for CWIQ |
...
| **msolap** | [Hugoberry/duckdb-msolap-extension](https://github.com/Hugoberry/duckdb-msolap-extension) | ✅ Ongoing | 0 days ago | 8 | C++ | DuckDB extension: msolap by Hugoberry |
...
| **snowflake** | [iqea-ai/duckdb-snowflake](https://github.com/iqea-ai/duckdb-snowflake) | ✅ Ongoing | 0 days ago | 9 | C++ | A powerful DuckDB extension that enables seamless ... |
...
| **bigquery** | [hafenkran/duckdb-bigquery](https://github.com/hafenkran/duckdb-bigquery) | ✅ Ongoing | 2 days ago | 130 | C++ | Integrates DuckDB with Google BigQuery, allowing d... |
| **flockmtl** | [dais-polymtl/flock](https://github.com/dais-polymtl/flock) | ✅ Ongoing | 2 days ago | 268 | C++ | FlockMTL: DuckDB extension for multimodal querying... |
...
| **nanoarrow** | [paleolimbot/duckdb-nanoarrow](https://github.com/paleolimbot/duckdb-nanoarrow) | ✅ Ongoing | 2 days ago | 44 | C++ | DuckDB extension: nanoarrow by paleolimbot |
...
| **h3** | [isaacbrodsky/h3-duckdb](https://github.com/isaacbrodsky/h3-duckdb) | ✅ Ongoing | 3 days ago | 220 | C++ | Bindings for H3 to DuckDB |
| **quack** | [duckdb/extension-template](https://github.com/duckdb/extension-template) | ✅ Ongoing | 3 days ago | 221 | Python | Template for DuckDB extensions to help you develop... |
...
| **bitfilters** | [Query-farm/bitfilters](https://github.com/Query-farm/bitfilters) | ✅ Ongoing | 4 days ago | 2 | C++ | A high-performance DuckDB extension providing prob... |
| **shellfs** | [Query-farm/shellfs](https://github.com/Query-farm/shellfs) | ✅ Ongoing | 4 days ago | 80 | C++ | DuckDB extension allowing shell commands to be use... |
| **stochastic** | [Query-farm/stochastic](https://github.com/Query-farm/stochastic) | ✅ Ongoing | 4 days ago | 11 | C++ | A DuckDB extension that add comprehensive statisti... |
| **textplot** | [Query-farm/textplot](https://github.com/Query-farm/textplot) | ✅ Ongoing | 4 days ago | 9 | C++ | A DuckDB community extension that enables text-bas... |
| **yaml** | [teaguesterling/duckdb_yaml](https://github.com/teaguesterling/duckdb_yaml) | ✅ Ongoing | 8 days ago | 9 | C++ |  A DuckDB to read and work with YAML files in a si... |
| **eeagrid** | [ahuarte47/duckdb-eeagrid](https://github.com/ahuarte47/duckdb-eeagrid) | ✅ Ongoing | 9 days ago | 0 | C++ | Functions for transforming XY coordinates to and f... |
...
| **gsheets** | [evidence-dev/duckdb_gsheets](https://github.com/evidence-dev/duckdb_gsheets) | ✅ Ongoing | 10 days ago | 297 | C++ | DuckDB extension to read and write Google Sheets u... |
...
| **chsql** | [Query-farm/duckdb-extension-clickhouse-sql](https://github.com/Query-farm/duckdb-extension-clickhouse-sql) | ✅ Ongoing | 28 days ago | 70 | C++ | DuckDB Community Extension implementing ClickHouse... |
...
| **httpserver** | [Query-farm/duckdb-extension-httpserver](https://github.com/Query-farm/duckdb-extension-httpserver) | ✅ Ongoing | 38 days ago | 230 | HTML | DuckDB HTTP API Server and Query Interface in a  C... |
...
| **http_client** | [Query-farm/duckdb-extension-httpclient](https://github.com/Query-farm/duckdb-extension-httpclient) | ✅ Ongoing | 53 days ago | 70 | C++ | DuckDB HTTP GET/POST Client in a Community Extensi... |
| **duckdb_mcp** | [teaguesterling/duckdb_mcp](https://github.com/teaguesterling/duckdb_mcp) | ✅ Ongoing | 55 days ago | 6 | C++ | A simple MCP server extension for DuckDB |
...
| **duck_tails** | [teaguesterling/duck_tails](https://github.com/teaguesterling/duck_tails) | ✅ Ongoing | 62 days ago | 2 | C++ | A DuckDB extension for exploring and reading git h... |
| **lindel** | [Query-farm/lindel](https://github.com/Query-farm/lindel) | ✅ Ongoing | 63 days ago | 50 | C++ | DuckDB Extension Linearization/Delinearization, Z-... |
| **capi_quack** | [duckdb/extension-template-c](https://github.com/duckdb/extension-template-c) | ✅ Ongoing | 64 days ago | 17 | C | (Experimental) C/C++ template for DuckDB extension... |
...
| **parser_tools** | [zfarrell/duckdb_extension_parser_tools](https://github.com/zfarrell/duckdb_extension_parser_tools) | ✅ Ongoing | 73 days ago | 15 | C++ | Parse sql - with sql! |
...
| **pbix** | [Hugoberry/duckdb-pbix-extension](https://github.com/Hugoberry/duckdb-pbix-extension) | ✅ Ongoing | 91 days ago | 27 | C++ | Duckdb extension for parsing the metadata and cont... |
...
| **radio** | [Query-farm/radio](https://github.com/Query-farm/radio) | ✅ Ongoing | 99 days ago | 30 | C++ | Radio is a DuckDB extension by Query.Farm that bri... |
...
| **crypto** | [Query-farm/crypto](https://github.com/Query-farm/crypto) | ✅ Ongoing | 102 days ago | 22 | Rust | DuckDB Extension for cryptographic hash functions ... |
| **pcap_reader** | [Query-farm/duckdb-extension-pcap](https://github.com/Query-farm/duckdb-extension-pcap) | ✅ Ongoing | 102 days ago | 10 | Rust | DuckDB PCAP Reader Extension made in Rust |
| **pyroscope** | [Query-farm/duckdb-extension-pyroscope](https://github.com/Query-farm/duckdb-extension-pyroscope) | ✅ Ongoing | 102 days ago | 19 | Rust | DuckDB Pyroscope Extension for Continuous Profilin... |
...
| **quackformers** | [martin-conur/quackformers](https://github.com/martin-conur/quackformers) | ✅ Ongoing | 111 days ago | 6 | Rust | DuckDB NLP extension. |
...
| **hostfs** | [gropaul/hostFS](https://github.com/gropaul/hostFS) | ✅ Ongoing | 193 days ago | 23 | C++ | DuckDB extension: hostfs by gropaul |
| **open_prompt** | [Query-farm/duckdb-extension-openprompt](https://github.com/Query-farm/duckdb-extension-openprompt) | ✅ Ongoing | 254 days ago | 50 | C++ | DuckDB Community Extension to prompt LLMs from SQL |
...
| **tsid** | [Query-farm/duckdb-extension-tsid](https://github.com/Query-farm/duckdb-extension-tsid) | ✅ Ongoing | 284 days ago | 5 | C++ | TSID Extension for DuckDB  |
| **sheetreader** | [polydbms/sheetreader-duckdb](https://github.com/polydbms/sheetreader-duckdb) | ✅ Ongoing | 339 days ago | 55 | Jupyter Notebook | DuckDB extension: sheetreader by polydbms |
| **pivot_table** | [Alex-Monahan/pivot_table](https://github.com/Alex-Monahan/pivot_table) | ✅ Ongoing | 362 days ago | 15 | C++ | Full spreadsheet-style pivot table through SQL mac... |
