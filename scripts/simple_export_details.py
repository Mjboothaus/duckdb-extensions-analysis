            ...
            data.append(
                {
                    ...
                    "last_push": ext.last_push.isoformat()
                    if ext.last_push
                    else "Unknown",
                    ...
                    if ext.last_activity and ext.last_activity <= 30
                    else "Low"
                    if ext.last_activity
                    else "Unknown",
                }
            )
            ...
            data.append(
                {
                    ...
                    "docs_url": ext.docs_url,
                    "activity_class": "Active"
                    if ext.last_activity and ext.last_activity <= 90
                    else "Low"
                    if ext.last_activity and ext.last_activity <= 365
                    else "Inactive"
                    if ext.last_activity
                    else "Unknown",
                }
